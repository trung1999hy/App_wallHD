package com.hst.offline.data.services;
...
import com.hst.offline.data.utils.SharedPref;
...
public class GifWallpaperService extends WallpaperService {
    ...
    public Engine onCreateEngine() {
        try {
            InputStream mInputStream = new BufferedInputStream(new FileInputStream(new File(SharedPref.getSharedPref(getApplicationContext()).read("set_wallpaper"))), 16384);
