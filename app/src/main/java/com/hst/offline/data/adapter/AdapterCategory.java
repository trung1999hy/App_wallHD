...
import com.hst.offline.ui.listcategory.ListCategoryActivity;
...
public class AdapterCategory extends Adapter<ViewHolder> {
    ...
    private final ArrayList<ModelWallpaperCategory> arrayList;
    ...
    public AdapterCategory(Activity activity2, ArrayList<ModelWallpaperCategory> arrayList2) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder_parent, int position) {
        final ModelWallpaperCategory modelWallpaperCategory = this.arrayList.get(position);
        if (!modelWallpaperCategory.category_image.equals("banner")) {
            ...
            String sb = Variable.assets_folder + modelWallpaperCategory.category_image;
            ...
            holder.title.setText(modelWallpaperCategory.category_folder);
            holder.itemView.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    Intent intent = new Intent(AdapterCategory.this.activity, ListCategoryActivity.class);
